...
import com.pony.fragment.HobbyMainFragment;
import com.pony.fragment.MainFragment;
...
//	private TextView person_text;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 初始化布局元素
		initViews();
		findViewById(R.id.mtvxuqiu).setOnClickListener(clickListener);
	...
	private OnClickListener clickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.mtvxuqiu:// 打开左边抽屉
					Intent intent = new Intent(FrameworkActivity.this, CreateXuQiuActivity.class);
...
//		if(!TextUtils.isEmpty(userModel.getUtype())){
